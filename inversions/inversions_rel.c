...
unsigned long long count_inversions(int* A, int n);
int* merge_sort(int* A, int n, unsigned long long* inversions_count);
int* merge(int* A, int size_a, int* B, int size_b, unsigned long long* inversions_count);
...
unsigned long long count_inversions(int* A, int n)
{
	unsigned long long inversions_count;
